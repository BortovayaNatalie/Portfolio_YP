...
**Цель:**
Выполнить проверку бизнес-гипотез. Проект выполнялся в тренажере Яндекс.Практикум без ревью.


## [Предобработка данных. Исследование надёжности заёмщиков](https://github.com/BortovayaNatalie/Portfolio_YP/blob/main/02-%20Исследование%20надежности%20заемщиков/Исследование%20надежности%20заемщиков%201.ipynb)
**Цель:**
Работа с пропусками. Изменение типов данных. Основные методы поиска дубликатов. Категоризация данных. Системное мышление. 
Проект: проверить влияние семейного положения и количества детей на платёжеспособность клиента банка. Исследование надёжности заёмщиков для кредитного отдела банка с целью построения модели кредитного скоринга
